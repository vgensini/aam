...
start_input = '19800823' #YYYYMMDD
end_input  =  '19800823' #YYYYMMDD
...
for dt in dates:
	...
	modname = 'CFS'
	if modname == 'CFS':
		dps=[1.,1.,2.,2.,3.,10.,10.,20.,20.,30.,25.,25.,25.,25.,25.,25.,50.,50.,50.,50.,50.,50.,50.,50.,50.,50.,25.,25.,25.,25.,25.,25.,25.,25.,25.,25.,13.]
